...
{
	ofstream fichierBilan("C:/Users/Kevin/Desktop/Bilan/Bilan des ventes V1.csv", ios::out | ios::trunc) ;
...
{
	ofstream fichierBilan("C:/Users/Kevin/Desktop/Bilan/Bilan des ventes V1.csv", ios::out | ios::app) ;
