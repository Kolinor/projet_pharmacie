object Ordonnance: TOrdonnance
  ...
  object f_Ordonnance: TFDConnection
    Params.Strings = (
      'Database=pharmacie'
      'User_Name=pharma'
      'Password=pharma'
  ...
  object FDQuery_Ordonnance: TFDQuery
    Connection = f_Ordonnance
    SQL.Strings = (
      'SELECT * FROM `Medicament` WHERE `Quantite_Restante` != 0')
    Left = 88
    Top = 584
  end
  object DataSource_Ordonnance: TDataSource
    DataSet = FDQuery_Ordonnance
    Left = 152
    Top = 584
  end
  object FDGUIxWaitCursor_Ordonnance: TFDGUIxWaitCursor
    Provider = 'Forms'
    Left = 216
    Top = 584
  end
