...
//  Constructeur, création d'un Thread et du tableau d'affichage de l'état de l'ordonnance
...
// Méthode Thread qui permet de récuperer l'état des commandes en temps réel
