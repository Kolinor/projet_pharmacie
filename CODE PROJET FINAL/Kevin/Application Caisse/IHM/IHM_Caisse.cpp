...
// Constructeur de l'IHM Caisse, création de l'objet BDD
...
// Bouton qui permet d'afficher l'interface de la visualisation de l'état des commandes
...
// Bouton qui permet d'afficher l'interface qui sert à télécharger les bilans de vente
